...
namespace Dissimilis.WebAPI.xUnit.Tests
{
    ...
    public class SongVoiceTests : BaseTestClass
    {
        ...
        public async Task TestUpdatingBar()
        {
            ...
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 7, length: 1)));
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 5, length: 3)));
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 4, length: 4)));
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 3, length: 5)));
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 2, length: 6)));
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 1, length: 7)));
            await mediator.Send(new UpdateSongNoteCommand( note1Post.SongChordId, GetUpdateNoteDto(note1Update1, position: 0, length: 8)));
        }
