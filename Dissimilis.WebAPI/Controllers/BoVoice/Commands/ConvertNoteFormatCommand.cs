...
{
    public class ConvertNoteFormatCommand : IRequest<UpdatedCommandDto>
    {
        ...
        public ConvertNoteFormatCommand(int songId, int songVoiceId)
        {
            SongId = songId;
    ...
    public class ConvertNoteFormatHandler : IRequestHandler<ConvertNoteFormatCommand, UpdatedCommandDto>
    {
