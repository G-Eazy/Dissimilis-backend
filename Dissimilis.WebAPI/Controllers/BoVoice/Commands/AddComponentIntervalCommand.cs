...
namespace Dissimilis.WebAPI.Controllers.BoVoice.Commands
{
    ...
    public class AddComponentIntervalHandler : IRequestHandler<AddComponentIntervalCommand, UpdatedCommandDto>
    {
        ...
        public AddComponentIntervalHandler(VoiceRepository voiceRepository, SongRepository songRepository, AuthService authService, _IPermissionCheckerService IPermissionCheckerService)
        {
